/* ASSIGNMENT 1 */
/* SECTION 2 */
/* Queries to do specific tasks requied for addinment 1 - Hema D
...
GROUP BY 
    ...
    customer_last_name
HAVING 
    SUM(quantity * cost_to_customer_per_qty) > 2000
ORDER BY 
    customer_last_name, 
    customer_first_name;
...
/*Create a temp table and copy existing vendor data */

CREATE TABLE IF NOT EXISTS temp.new_vendor AS
SELECT * FROM vendor;
